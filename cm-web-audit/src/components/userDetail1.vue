    ...
    <div class="creditUser">
        <div class="table_show">
            <table class="headerTb" border="0" cellpadding="0" cellspacing="0">
                <tr v-for="i in tbData.info" :key="i">
                    <td class="txt_center" v-html="i[0].title"></td>
                    <td v-if="i[0].btn!=undefined">
                      <Row>
                        <Col :sm="20" :xs="24">
                           <p v-html="i[0].val"></p>
                           </Col><Col :sm="4" :xs="24">
                           <Button type="ghost" @click="" size="small" v-text="i[0].btn"></Button>
                        </Col>
                     </Row>
                    </td>
                    <td v-else v-html="i[0].val"></td>
                    <td class="txt_center" v-html="i[1].title"></td><td v-html="i[1].val"></td>
                </tr>
                <tr>
                    <td colspan="4"><h3>实名信息</h3></td>
                </tr>
                <tr v-for="c in tbData.credit" :key="c">
                ...
                <tr><td colspan="4">
                    ...
                    <Row class="photoShow docs-pictures">
                        <Col :sm="10" :xs="24">
                            <Row :gutter="16">
                                <Col :sm="8" :xs="12" v-for="item in uploadList" :key="item">
