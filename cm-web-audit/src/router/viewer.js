...
function(i) {
    ...
    u.prototype = {
        ...
        bind: function() {
            ...
            this.$viewer.on(A, i.proxy(this.click, this)).on(q, i.proxy(this.wheel, this)),
            ...
            m.on(_, this._resize = o(this.resize, this))
        },
        unbind: function() {
            var t = this.options,
            e = this.$element;
        ...
        initList: function() {
            ...
            this.$images.each(function(s) {
                ...
                n && (t(h) ? h = this.getAttribute(h) : i.isFunction(h) && (h = h.call(this, this)), 
                    o.push('<li><img src="' + n + '" data-action="view" data-index="' + s 
                        + '" data-original-url="' + (h || n) + '" alt="' + a + '"></li>'))
            }),
        ...
        resize: function() {
            ...
            this.renderViewer(),
            this.renderList(),
            this.isViewed && this.initImage(i.proxy(function() {
                this.renderImage()
            },
            this)),
        ...
        play: function() {
            ...
            this.isShown && !this.isPlayed && (s.fullscreen && this.requestFullscreen(), this.isPlayed = !0, n.addClass(b), this.$items.each(function(t) {
                ...
                h++,
                d.addClass(F).toggleClass(X, s.transition),
                e.hasClass(k) && (d.addClass(z), r = t),
                a.push(d),
                d.one(M, {
                    filled: !1
                },
        ...
        full: function() {
            ...
            e = this.$image,
            s = this.$list;
            this.isShown && !this.isPlayed && !this.isFulled && t.inline && (this.isFulled = !0, this.$body.addClass(p), this.$button.addClass(P), t.transition && (e.removeClass(X), s.removeClass(X)), this.$viewer.addClass(w).removeAttr("style").css("z-index", t.zIndex), this.initContainer(), this.viewer = i.extend({},
        ...
        exit: function() {
            ...
            e = this.$image,
            s = this.$list;
            this.isFulled && (this.isFulled = !1, this.$body.removeClass(p), this.$button.removeClass(P), t.transition && (e.removeClass(X), s.removeClass(X)), this.$viewer.removeClass(w).css("z-index", t.zIndexInline), this.viewer = i.extend({},
        ...
        tooltip: function() {
            ...
            this.isViewed && !this.isPlayed && t.tooltip && (e.text(G(100 * s.ratio) + "%"), this.tooltiping ? clearTimeout(this.tooltiping) : t.transition ? (this.fading && e.trigger(R), e.addClass(n), h(e[0]), e.addClass(z)) : e.addClass(b), this.tooltiping = setTimeout(i.proxy(function() {
                ...
                this)).removeClass(z), this.fading = !0) : e.removeClass(b),
                this.tooltiping = !1
            },
            this), 1e3))
        },
        ...
        destroy: function() {
            var i = this.$element;
            this.options.inline ? this.unbind() : (this.isShown && this.unbind(), i.off(A, this.start)),
            this.unbuild(),
            i.removeData(f)
        },
